...
ctor_Server_DH_inner_data_init(method_req_pq_t m1, method_req_DH_params_t m2)
{
  ...
  buf_t new_nonce_plus_server_nonce_hash = api.hsh.sha1(new_nonce_plus_server_nonce);
  ...
  buf_t server_nonce_plus_new_nonce_hash = api.hsh.sha1(server_nonce_plus_new_nonce);
  buf_t substr_sha1_server_nonce_new_nonce012 = api.buf.add(server_nonce_plus_new_nonce_hash.data, 12);
  buf_t tmp_aes_key = {};
  ...
  buf_t substr_sha1_server_nonce_new_nonce128 = api.buf.add(server_nonce_plus_new_nonce_hash.data + 12, 8);
